...
class SpplAdminController extends Controller
{
  public function index(){
      $this->AdminAuthCheck();
      $admin_all_izin=DB::table('izin')
                  ->join('matriks', 'matriks.matriks_id', '=', 'izin.matriks_id')
                  ->select('izin.*', 'matriks.*')
                  ->get();
  ...
  public function detail_izin($izin_id){
    $izin_by_details=DB::table('izin')
                        ...
                        ->join('matriks', 'matriks.matriks_id', '=', 'izin.matriks_id')
                        ->select('izin.*', 'pemrakarsa.no_ktp', 'pemrakarsa.jabatan', 'pemrakarsa.alamat', 'matriks.jenis_usaha')
