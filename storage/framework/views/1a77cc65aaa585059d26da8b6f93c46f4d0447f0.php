	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w" action="<?php echo e(url('/pemrakarsa-login')); ?>" method="post">
					...
					<p>Click <a href="/registrasi" align="center">Here</a> to register.</p>
...
<?php /**PATH C:\xampp\htdocs\SistemInformasiSPPL\resources\views/pemrakarsa/pemrakarsa_login.blade.php ENDPATH**/ ?>