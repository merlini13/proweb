		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<form class="form-horizontal" action="{{url('/save-admin-account')}}" method="post">
            {{csrf_field()}}
						<fieldset>
              ...
              <div class="input-prepend" title="Password">
								...
								<input class="input-large span10" name="admin_password" type="password" id="password" placeholder="type password"/>
							</div>
							<div class="clearfix"></div>

              <div class="input-prepend" title="Username">
								<span class="add-on"><i class="halflings-icon user"></i></span>
								<input class="input-large span10" name="admin_name" type="text" placeholder="type name"/>
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Phone Number">
								<span class="add-on"><i class="halflings-icon user"></i></span>
								<input class="input-large span10" name="admin_phone" id="password" type="text" placeholder="type phone number"/>
							</div>
              ...
              <p>Click <a href="/admin-login" align="center">Here</a> to login.</p>
					</form>
					<hr>
				</div><!--/span-->
			</div><!--/row-->
